...
public class CRUD_factura extends JPanel {
    ...
    public CRUD_factura(Gestor_Factura invoice) {
        ...
        Object[] header = new Object[]{"   id", "   client", "   date",
            "   products", "", ""};
        //modificar
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            matriz[i][1] = data.get(i).getClient();
            matriz[i][2] = data.get(i).getClient();
            matriz[i][3] = data.get(i).getDate();
            matriz[i][4] = data.get(i).getProducts();
